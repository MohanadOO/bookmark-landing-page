    ...
    <header id='header' className='mt-20 md:mt-32 mx-2 relative text-center'>
      <div className='md:flex md:flex-row-reverse md:items-center md:text-left md:gap-10'>
        <div className='relative flex mb-10'>
          <div className='absolute min-h-[200px] max-w-[300px] w-full lg:max-w-[500px] lg:min-h-[300px] bg-primary-soft-blue right-0 top-5 translate-x-10 rounded-tl-full rounded-bl-full md:bottom-5 md:top-auto md:translate-x-[88px]'></div>
          <img
