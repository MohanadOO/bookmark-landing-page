...
function FeaturesTabs({ tab }) {
  return (
    <div id='features_tab'>
      <div className='md:flex md:items-center  md:text-left md:gap-24 lg:gap-0'>
        <div className='relative flex mb-10 md:mt-20 xl:px-36'>
          <div className='absolute min-h-[200px] max-w-[300px] w-full lg:max-w-[500px] lg:min-h-[300px]  bg-primary-soft-blue left-0 top-5 md:top-auto md:bottom-0 -translate-x-10 md:-translate-x-20 md:translate-y-10 rounded-tr-full rounded-br-full'></div>
          <img
